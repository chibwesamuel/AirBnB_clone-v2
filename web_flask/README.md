...
In this project, I continue wrking on my AirBnB project. This time the concentration turns to web framework where I use Python, Flask to work on the backend of my web application.
